    ...
    <>
      ...
      {isLoading ? (
        ...
        <Box p={20}>
          ...
          <Image src={process.env.NEXT_PUBLIC_API_BASE + post.thumbnail.data.attributes.url} h="60vh" objectFit={"cover"} w="100%" />
          ...
          <Box my={8} dangerouslySetInnerHTML={{ __html: marked.parse(post.content) }}></Box>
